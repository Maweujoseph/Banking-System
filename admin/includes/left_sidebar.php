<div class="left-side-bar">
		<div class="brand-logo">
			<a href="admin_dashboard.php">
				<img src="../vendors/images/trojan(9).png" alt="" class="dark-logo">
				<img src="../vendors/images/trojan(9).png" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<div class="sidebar-small-cap">Group 12</div>
					</li>
					<li>
						<a href="" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-edit-2"></span><span class="mtext">Group Members</span>
						</a>
					</li>
				</ul>
			</div>
